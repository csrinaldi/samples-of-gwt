...
import com.logikas.samples.gwt.cellwidget.client.ContactDatabase.Category;
import com.logikas.samples.gwt.cellwidget.client.ContactDatabase.ContactInfo;
...
public class CwCustomDataGrid {
     ...
     */
    //@ShowcaseSource
    private class CustomHeaderBuilder extends AbstractHeaderOrFooterBuilder<ContactDatabase.ContactInfo> {

        private Header<String> firstNameHeader = new TextHeader("constants.cwCustomDataGridColumnFirstName()");
        private Header<String> lastNameHeader = new TextHeader("constants.cwCustomDataGridColumnLastName()");
        private Header<String> ageHeader = new TextHeader("constants.cwCustomDataGridColumnAge()");
        private Header<String> categoryHeader = new TextHeader("constants.cwCustomDataGridColumnCategory()");
        private Header<String> addressHeader = new TextHeader("constants.cwCustomDataGridColumnAddress()");
        ...
        protected boolean buildHeaderOrFooterImpl() {
             ...
             */
            TableCellBuilder th = tr.startTH().colSpan(4).className(groupHeaderCell);
         ...
         * @param isSortAscending true if the sorted column is in ascending
         * order
